...
and the DESTROY bullet damages an enemy.

One difficulty we encountered was the installation and setup for SDL since whenever we tried to run the program on certain of our local
computers, the program would crash and call up errors and we couldn't fix it properly. 
